...
import type { SealedCookie, SessionCookies } from './cookies'
...
const { adminSession } = await import('./session')

const session = (): Promise<SessionCookies> => adminSession(ADMIN_COOKIE)
