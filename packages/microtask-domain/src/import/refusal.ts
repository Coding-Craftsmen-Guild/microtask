...
const BOUNDS: Readonly<Record<MicrotaskCountKey, string>> = {
 ...
 */
export const overBound = (key: MicrotaskCountKey, count: number, whose: string): readonly string[] =>
  when(
    count > LIMITS[key],
