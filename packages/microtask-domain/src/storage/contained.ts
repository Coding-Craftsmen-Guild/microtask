 ...
 * primary defence — `isUlid` and `isProduct` reject an untrusted segment outright, which
 * is why no public builder can reach the throw and why this module is tested directly.
 *
