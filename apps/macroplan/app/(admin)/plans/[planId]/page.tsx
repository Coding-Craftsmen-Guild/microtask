 ...
 * for a reason that does not apply to an empty panel — the table is "the only rendering of a plan a
 * screen reader can read", so hiding it would cost a reader the plan, where a second always-mounted
 * panel with nothing in it costs a reader a container and says nothing. A sentence in its place is
 * markup somebody reads.
 *
