...
export const seatPlanActions = (token: string): PlanEditActions => ({
  ...
  createLabel: seatCreateLabel.bind(null, token),
  renameLabel: seatRenameLabel.bind(null, token),
  recolourLabel: seatRecolourLabel.bind(null, token),
  removeLabel: seatRemoveLabel.bind(null, token),
  labelFeature: seatLabelFeature.bind(null, token),
