 ...
 *
 * Every rule about what a refusal may disclose is shared with Microtask — a wrong password and an
 * unknown service key are indistinguishable, and only a 5xx or an unreachable API is told apart.
 * The one thing this app supplies is the sentence for that last case, because it names Macroplan.
 */
