      ...
      'no-restricted-imports': ['error', {
        patterns: [
          ...
          },
          {
            ...
            message: 'this app may import only @repo/api-client, @repo/app-session, @repo/contracts and @repo/ui; anything else is a decision to record before it is a dependency (ADR 0027)',
          },
        ],
      }],
    },
